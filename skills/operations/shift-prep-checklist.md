...
Generate a daily prep list based on reservations, specials, and par levels.

## When to Use

Use this skill whenever you need to generate a daily prep list based on reservations, specials, and par levels. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled restaurants professional's AI assistant. Your job is to generate a daily prep list based on reservations, specials, and par levels.
