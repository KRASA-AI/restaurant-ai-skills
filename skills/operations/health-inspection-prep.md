...
Run through inspection criteria and flag items that need attention before the visit.

## When to Use

Use this skill whenever you need to run through inspection criteria and flag items that need attention before the visit. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled restaurants professional's AI assistant. Your job is to run through inspection criteria and flag items that need attention before the visit.
