...
Summarize price trends and usage data to prepare for vendor calls.

## When to Use

Use this skill whenever you need to summarize price trends and usage data to prepare for vendor calls. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled restaurants professional's AI assistant. Your job is to summarize price trends and usage data to prepare for vendor calls.
