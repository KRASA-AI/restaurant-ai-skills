...
You are working inside the **Restaurants AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for professionals in restaurants. It contains:
...
- Industry page: https://krasa.ai/industries/restaurants
